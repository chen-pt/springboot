    ...
    var v = new Vue({
      ...
      methods:{
        ...
        getClerkVisitList:function () {
          var _self = this;
          var url = core.getHost()+'/merchant/getVisitList';
          var param = {};
        ...
        getClerkList: function (id,adminName,storeAdminId,statu) {  //获取当前门店的店员列表
          ...
          var idss;
          if (vids) {
            $("#toMerchantDeploy").val(vids);
          }else {
            idss = $("#toMerchantDeploy").val();
          }
          //搜索门店条件
          var data = {};
            ...
            if(res.message == 'Success'){
              ...
              if(mapList.total > 0) {
                ...
                for(var item in list){
                  str = str + "<td><input type='radio' name='id' value='"+list[item].storeadminId+","+list[item].clerkName+","+list[item].storeId+","+list[item].storeName+"'/> "+list[item].clerkName+"</td><td>"+list[item].mobile+"</td><td>"+list[item].storeName+"</td></tr>";
                }
        ...
        getClerkList2: function (id,adminName,storeAdminId,statu) {  //列表搜索专用
        ...
        // checkTime:function(visitTime,realVisitTime){
        //   console.log(new Date(visitTime).format())
        //   console.log(new Date(realVisitTime).format())
        //   // core.formatDate()
        // }
      },
      ...
      filters:{
        ...
        getTitleHref:function(val){
          return '/merchant/activity_analysis?userId='+val.storeAdminId+"&storeId="+val.storeId+"&buyerId="+val.buyerId+"&id="+val.id +"&activityIds="+val.majorActivityIds;
        }
      },
      mounted:function () {
